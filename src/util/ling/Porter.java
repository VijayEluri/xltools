...
public class Porter {
	private static String[] posTriggerWords = new String[] {"good", "great","nice","sharp","fast","accurate","crisp","clear"};
	private static String[] negTriggerWords = new String[] {"bad","blur","slow","broken","poor","cracked","delay","fuzzy"};
	
	public static void main(String[] args){
		Porter p = new Porter();
		System.out.println(p.stripAffixes("co-transfected"));
//		for (String s : posTriggerWords)
//			System.out.println(p.stripAffixes(s));
//		for (String s : negTriggerWords)
//			System.out.println(p.stripAffixes(s));
	}
